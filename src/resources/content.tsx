...
  work: {
    display: true,
    title: "Experiência Profissional", // Título ajustado para corresponder ao tipo 'Work'
    experiences: [], // Vazio, pois os certificados estão na seção 'studies'
  },
  studies: {
    display: true,
    title: "Formação e Certificados", // Título ajustado para incluir Certificados
    institutions: [
      {
...
        ),
      },
      // Certificados transferidos para a seção de estudos
      {
        name: "Alura",
        description: (
          <span className="transition duration-300 hover:text-primary">
            Certificação Front-end: Curso de HTML, CSS e JavaScript aplicado ao desenvolvimento moderno de interfaces.
          </span>
        ),
      },
      {
